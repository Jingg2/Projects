...
$google_oauth_client_id = '718904999725-2r06is3pot2bht3jfphcjiv82d29t69j.apps.googleusercontent.com';
$google_oauth_client_secret = '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';
$google_oauth_redirect_uri = 'http://localhost:3000/google-login/google-oauth.php';
...
if (isset($_GET['code']) && !empty($_GET['code'])) {
    ...
    if (isset($response['access_token']) && !empty($response['access_token'])) {
        ...
        if (isset($profile['email'])) {
            ...
            // Ari mo mag redirect para ma move sa home
            // header('Location: /google-login/profile.php');
